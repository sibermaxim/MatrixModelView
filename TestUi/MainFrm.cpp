...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//m_wndDlgBar.AttachToTabWnd(&m_wndOutput, DM_SHOW, TRUE, &pTabbedBar1);
...
BOOL CMainFrame::CreateDockingWindows()
{
	...
	if (!m_wndDlgBar.Create(_T("Вычисление матриц"), this, TRUE,
		MAKEINTRESOURCE(IDD_MATRIX_COMPUTE),
		WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_BOTTOM | CBRS_FLOAT_MULTI, ID_VIEW_DLGBAR))
	{
		TRACE0("Failed to create Output window\n");
		return FALSE; // failed to create
	}
...
void CMainFrame::OnShowWindow(BOOL bShow, UINT nStatus)
{
	...
	CView *pView = this->GetActiveView(); //(CTestUiView)pFrame->GetActiveView();
